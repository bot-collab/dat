...
{
	padding: 2px 9px;
	background: #f1f2f6 url('/DXR.axd?r=0_888-K2F8m') repeat-x left top;
}
.dxdvControl_DevEx .dxdvPPSpacing
{
	background: url('/DXR.axd?r=0_889-K2F8m') no-repeat center top;
}
.dxdvEmptyData_DevEx
{
	color: #201f35;
...
{
	background: #f1f2f6 url('/DXR.axd?r=0_901-K2F8m') repeat-x left top;
	border: 1px solid #9da0aa;
	padding: 0;
}
...
{
	background: #edeff7 url('/DXR.axd?r=0_902-K2F8m') repeat-x left top;
}
.dxmLite_DevEx .dxm-popup .dxm-selected
{
	background: #e9eaee url('/DXR.axd?r=0_903-K2F8m') repeat-x left top;
...
{
	background: url('/DXR.axd?r=0_899-K2F8m') no-repeat left center;
}
.dxmLite_DevEx .dxm-horizontal .dxm-image-t .dxm-separator b,
.dxmLite_DevEx .dxm-horizontal .dxm-image-b .dxm-separator b
{
	background: url('/DXR.axd?r=0_900-K2F8m') no-repeat left center;
}
.dxmLite_DevEx .dxm-vertical .dxm-separator b
{
	background: #f8f8fa url('/DXR.axd?r=0_908-K2F8m') no-repeat center top;
	height: 1px;
}
.dxmLite_DevEx .dxm-popup .dxm-separator b
{
	background: url('/DXR.axd?r=0_907-K2F8m') no-repeat left top;
	height: 1px;
}
...
.dxmLite_DevEx .dxm-scrollBtnHovered
{
	background: #e2e9ff url('/DXR.axd?r=0_904-K2F8m') repeat-x left top;
}
.dxmLite_DevEx .dxm-scrollBtnPressed
{
	background: #f2f2f6 url('/DXR.axd?r=0_905-K2F8m') repeat-x left top;
}
...
{
	background: #f0f1f3 url('/DXR.axd?r=0_909-K2F8m') repeat-x left top;
...
{
	background: #e9eaee url('/DXR.axd?r=0_911-K2F8m') repeat-x left top;
	border: 1px solid #a6a9b2;
}
.dxnbLite_DevEx .dxnb-itemHover,
.dxnbLite_DevEx .dxnb-largeHover
{
	background: #e3eafe url('/DXR.axd?r=0_910-K2F8m') repeat-x left top;
	border: 1px solid #a6a9b2;
}
.dxnbLite_DevEx .dxnb-header,
.dxnbLite_DevEx .dxnb-headerCollapsed, 
...
{
	background: url('/DXR.axd?r=0_912-K2F8m') no-repeat center top;
}
.dxncItem_DevEx
{
	vertical-align: top;
...
{
    background: #e6edfe url('/DXR.axd?r=0_915-K2F8m') repeat-x left top;
    border-color: #c0c9e3;
}
.dxpLite_DevEx .dxp-pressedDropDownButton
{
    background: #e3e5e8 url('/DXR.axd?r=0_916-K2F8m') repeat-x left top;
    border-color: #c2c4cb;
}
...
.dxpLite_DevEx .dxp-sep
{
	background-image: url('/DXR.axd?r=0_917-K2F8m');
	width: 1px;
	height: 15px;
	margin-top: 1px;
	padding: 0;
...
{
	color: #5d5c6d;
	background: #c8c9d0 url('/DXR.axd?r=0_914-K2F8m') repeat-x left top;
...
{
	color: #80838f;
	background: #c9cad1 url('/DXR.axd?r=0_913-K2F8m') repeat-x left top;
...
.dxrpControl_DevEx td.dxrpHeader_DevEx
{
	background: #f0f1f5 url('/DXR.axd?r=0_925-K2F8m') repeat-x left top;
}
...
.dxtcLite_DevEx > .dxtc-stripContainer .dxtc-activeTab
{
	background: #ebebee url('/DXR.axd?r=0_932-K2F8m') repeat-x center top;
	float: left;
	overflow: hidden;
	text-align: center;
	white-space: nowrap;
...
{
	background: #e1e8fd url('/DXR.axd?r=0_933-K2F8m') repeat-x center top;
}
.dxtcLite_DevEx > .dxtc-stripContainer .dxtc-spacer 
{
	width: 1px;
...
{
	color: #5d5c6d;
	background: #eeeff2 url('/DXR.axd?r=0_935-K2F8m') repeat-x left top;
	padding: 0 4px 1px;
...
{
	color: #201f35;
	background: #eff1f3 url('/DXR.axd?r=0_934-K2F8m') repeat-x left top;
	padding: 10px;
}
...
.dxucBrowseButton_DevEx
{
	padding: 4px 15px;
	border: 1px solid #A9ACB5;
	background: #EBEDF2 url('/DXR.axd?r=0_937-K2F8m') repeat-x;
}
...
{
	background: #DDE6FE url('/DXR.axd?r=0_939-K2F8m') repeat-x;
}
.dxucBrowseButtonPressed_DevEx
{
	border: 1px solid #9DA0AA;
	background: #DBDDE2 url('/DXR.axd?r=0_940-K2F8m') repeat-x;
}
...
.dxucProgressBar_DevEx
{
	background: #f3f4f5 url('/DXR.axd?r=0_941-K2F8m') repeat-x left top;
...
{
	background: #edd0f4 url('/DXR.axd?r=0_942-K2F8m') repeat-x left top;
}
...
{
	border-color: #E1E2E5;
	background: #F8F9FA url('/DXR.axd?r=0_938-K2F8m') repeat-x;
}
...
{
	background-image: url('/DXR.axd?r=0_928-K2F8m');
}
.dxsplHSeparatorHover_DevEx,
.dxsplHSeparatorButtonHover_DevEx
{
	background-image: url('/DXR.axd?r=0_926-K2F8m');
}
.dxsplVSeparatorHover_DevEx,
.dxsplHSeparatorHover_DevEx,
.dxsplVSeparatorButtonHover_DevEx,
...
{
	background: url('/DXR.axd?r=0_927-K2F8m') repeat;
	font-size: 0;
	line-height: 0px;
}
...
{
	background: #F2F2F7 url('/DXR.axd?r=0_901-K2F8m') repeat-x top left;
}
...
{
	width: 3px;
	background: url('/DXR.axd?r=0_894-K2F8m') repeat-y right;
	border-width: 0px;
}
...
{
    background-image: url('/DXR.axd?r=0_897-K2F8m');
...
.dxigItem_DevEx
{
    ...
    background-repeat: no-repeat;
    background-position:center center;
    background-image: url('/DXR.axd?r=0_895-K2F8m');
}
.dxigItem_DevEx a
{
    outline: 0;
...
{
    width: 43px;
    background: url('/DXR.axd?r=0_896-K2F8m') repeat-y;
}
.dxigControl_DevEx .dxig-bottomPanel .dxis-nbBottom > .dxis-prevBtnHorWrapper
{
...
.dxrControl_DevEx .dxr-groupList .dxr-groupSep b {
    ...
    width: 1px;
    height: 100%;
    background: #e9eaec url('/DXR.axd?r=0_922-K2F8m') repeat-x bottom;
}
...
.dxrControl_DevEx .dxr-olmGrExpBtn.dxr-itemHover {
    background: #e3ebff url('/DXR.axd?r=0_923-K2F8m') repeat-x left top;
    border-color: #a6a9b2;
}
...
.dxrControl_DevEx .dxtcLite_DevEx.dxtc-top .dxtc-tab.dxr-fileTab {
    background: #ebedf2 url('/DXR.axd?r=0_919-K2F8m') repeat-x;
    border-color: #9da0aa;
    border-width: 1px;
}
.dxrControl_DevEx .dxtcLite_DevEx.dxtc-top .dxtc-tabHover.dxr-fileTab {
    background: #dde6fe url('/DXR.axd?r=0_920-K2F8m') repeat-x;
}
.dxrControl_DevEx .dxtcLite_DevEx.dxtc-top .dxr-fileTabPressed.dxr-fileTab {
    background: #dbdde2 url('/DXR.axd?r=0_921-K2F8m') repeat-x;
}
