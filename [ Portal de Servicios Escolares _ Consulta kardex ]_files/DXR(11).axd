...
{
	background-image: url('/DXR.axd?r=0_762-K2F8m');
	height: 15px;
	width: 15px;
}
...
{
	background: #d9e4fd url('/DXR.axd?r=0_755-K2F8m') repeat-x left top;
	color: #201f35;
}
...
.dxgvHeader_DevEx
{
	...
	background: #f2f3f4 url('/DXR.axd?r=0_757-K2F8m') repeat-x left top;
	overflow: hidden;
	font-weight: normal;
	text-align: left;
}
...
{
    color: #201f35;
    background: #ebecef url('/DXR.axd?r=0_756-K2F8m') no-repeat right top;
...
.dxgvTable_DevEx caption
{
	...
	padding: 3px 3px 5px;
	text-align: center;
	background: #f2f3f4 url('/DXR.axd?r=0_759-K2F8m') repeat-x left top;
	color: #201f35;
...
{
	background: #f1f2f6 url('/DXR.axd?r=0_758-K2F8m') repeat-x left top;
}
