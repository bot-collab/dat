...
{
	background: url('/DXR.axd?r=0_1227-K2F8m') repeat-x top;
}
.dxmLite_Glass .dxm-vertical .dxm-image-t .dxm-item,
.dxmLite_Glass .dxm-vertical .dxm-image-b .dxm-item
{
	background: url('/DXR.axd?r=0_1221-K2F8m') repeat-x top;
}
.dxmLite_Glass .dxm-horizontal
{
	background: url('/DXR.axd?r=0_1218-K2F8m') repeat-x top;
}
...
{
	background: White url('/DXR.axd?r=0_1220-K2F8m') repeat-x top;
}
...
{
	background: #CBCBCB url('/DXR.axd?r=0_1219-K2F8m') repeat-x top;
}
...
{
	background: White url('/DXR.axd?r=0_1229-K2F8m') repeat-x top;
}
...
{
	background: #CBCBCB url('/DXR.axd?r=0_1228-K2F8m') repeat-x top;
}
...
{
	background: White url('/DXR.axd?r=0_1223-K2F8m') repeat-x top;
}
.dxmLite_Glass .dxm-main .dxm-image-t .dxm-hovered,
.dxmLite_Glass .dxm-main .dxm-image-b .dxm-hovered
{
	background: #CBCBCB url('/DXR.axd?r=0_1222-K2F8m') repeat-x top;
}
...
.dxmLite_Glass .dxm-scrollDownBtn
{
	...
	background: #F8F9FA url('/DXR.axd?r=0_1224-K2F8m') repeat-x top;
	padding: 2px;
	text-align: center;
}
.dxmLite_Glass .dxm-scrollUpBtn
...
{
	background: #B9D9DD url('/DXR.axd?r=0_1225-K2F8m') repeat-x top;
	border: 1px solid #87b8c7;
}
.dxmLite_Glass .dxm-scrollBtnPressed
{
	background: #508BA6 url('/DXR.axd?r=0_1226-K2F8m') repeat-x top;
...
{
	color: #333333;
	background: url('/DXR.axd?r=0_1230-K2F8m') repeat-x top;
...
{
	background: url('/DXR.axd?r=0_1231-K2F8m') repeat-x top;
}
...
.dxpLite_Glass .dxp-dropDownButton
{
    font-size: 0;
    padding: 6px 4px 5px;
    background: #45829F url('/DXR.axd?r=0_1237-K2F8m') repeat-x top;
	border: 1px solid #4986a2;
}
.dxpLite_Glass .dxp-hoverDropDownButton
{
    background: #35acd2 url('/DXR.axd?r=0_1239-K2F8m') repeat-x top;
	border: 1px Solid #4986a2;
}
.dxpLite_Glass .dxp-pressedDropDownButton
{
    background: #35657b url('/DXR.axd?r=0_1240-K2F8m') repeat-x top;
...
.dxpLite_Glass .dxp-disabledDropDownButton
{
    cursor: default;
    color: #93a1a4;
	background: #cdd7db url('/DXR.axd?r=0_1238-K2F8m') repeat-x left top;
	border-color: #c2c3c4;
}
...
{
	color: #5A5A5A;
	background: url('/DXR.axd?r=0_1235-K2F8m') repeat-x top;
	border-bottom: 1px solid #D5D5D5;
...
{
	color: #175B89;
	background: #D3E6F3 url('/DXR.axd?r=0_1234-K2F8m') repeat-x top;
...
.dxrpControlGB_Glass > tbody > tr.dxrpCR > .dxrpcontent
{
	background: #EBF2F4 url('/DXR.axd?r=0_1245-K2F8m') repeat-x left bottom;
}
.dxrpControl_Glass td.dxrpHeader_Glass
{
	background: White url('/DXR.axd?r=0_1246-K2F8m') repeat-x left bottom;
}
/* Disabled */
.dxrpDisabled_Glass,
...
.dxsmLevel0Categorized_Glass
{
	...
	padding: 3px 7px 4px;
	border: 1px Solid #D5D5D5;
	background: url('/DXR.axd?r=0_1247-K2F8m') repeat-x top;
}
...
.dxtcLite_Glass > .dxtc-stripContainer .dxtc-activeTab
{
	background: #F1F2F4 url('/DXR.axd?r=0_1265-K2F8m') repeat-x top;
...
.dxtcLite_Glass > .dxtc-stripContainer .dxtc-activeTab
{
	...
	background: #4986a2 url('/DXR.axd?r=0_1256-K2F8m') repeat-x top;
}
...
{
	background: #EDF3F4 url('/DXR.axd?r=0_1232-K2F8m') repeat-x top;
	float: left;
	clear: left;
	border: 1px solid #4986A2;
	overflow: hidden;
...
{
	background: #46819E url('/DXR.axd?r=0_1261-K2F8m') repeat-x;
	border: 1px solid #4986A2;
	padding: 5px 6px;
}
.dxtcLite_Glass > .dxtc-stripContainer .dxtc-sbHover
{
	...
	background: #74BCDB url('/DXR.axd?r=0_1263-K2F8m') repeat-x;
}
.dxtcLite_Glass > .dxtc-stripContainer .dxtc-sbPressed
{
	border: 1px solid #7DACC2;
	background: #86B5C9 url('/DXR.axd?r=0_1264-K2F8m') repeat-x;
}
.dxtcLite_Glass > .dxtc-stripContainer .dxtc-sbDisabled
{
	cursor: default;
	border-color: #C0C0C0;
	background: #C7C7C7 url('/DXR.axd?r=0_1262-K2F8m') repeat-x;
}
...
{
	background: #FFFFFF url('/DXR.axd?r=0_1266-K2F8m') repeat-x bottom;
	border-top: 1px solid #4986A2;
}
.dxtcLite_Glass.dxtc-bottom > .dxtc-stripContainer .dxtc-activeTab
{
	background: #94b8cc url('/DXR.axd?r=0_1257-K2F8m') repeat-x bottom;
	border-top: 1px solid #94B8CC;
	border-bottom: 1px solid #4986A2;
}
.dxtcLite_Glass.dxtc-bottom > .dxtc-content
{
	background: #EDF3F4 url('/DXR.axd?r=0_1233-K2F8m') repeat-x bottom;
	border-top: 1px solid #4986A2;
	border-right: 1px solid #4986A2;
...
.dxtiGroupHeaderText_Glass
{
	...
	background: url('/DXR.axd?r=0_1267-K2F8m') repeat-x top;
}
...
.dxucBrowseButton_Glass
{
	...
	border: 1px solid #B2BCBE;
	background: #DADFE0 url('/DXR.axd?r=0_1272-K2F8m') repeat-x;
}
...
{
	border-color: #71ACB4;
	background: #B5D7DB url('/DXR.axd?r=0_1273-K2F8m') repeat-x;
}
.dxucBrowseButtonPressed_Glass
{
	border-color: #71ACB4;
	background: #9ABDC1 url('/DXR.axd?r=0_1274-K2F8m') repeat-x;
}
...
{
	border: 1px Solid #4986a2;
	background: #C6E0E4 url('/DXR.axd?r=0_1275-K2F8m') repeat-x;

    height: 25px;
}
.dxucProgressBarIndicator_Glass
{
	background: #4986a2 url('/DXR.axd?r=0_1276-K2F8m') repeat-x;
}
...
.dxsplVSeparator_Glass
{
	background-image: url('/DXR.axd?r=0_1251-K2F8m');
	border-top-width: 1px;
	border-bottom-width: 1px;
}
.dxsplHSeparator_Glass
{
	background-image: url('/DXR.axd?r=0_1248-K2F8m');
	border-left-width: 1px;
	border-right-width: 1px;
}
...
{
	background-image: url('/DXR.axd?r=0_1252-K2F8m');
}
.dxsplHSeparatorHover_Glass,
.dxsplHSeparatorButtonHover_Glass
{
	background-image: url('/DXR.axd?r=0_1249-K2F8m');
}
.dxsplVSeparatorCollapsed_Glass,
.dxsplHSeparatorCollapsed_Glass
{
...
{
	background: url('/DXR.axd?r=0_1250-K2F8m') repeat;
	font-size: 0;
	line-height: 0px;
}
...
{
	background: url('/DXR.axd?r=0_1270-K2F8m') repeat-y;
	vertical-align: top;
}
...
.dxtvControl_Glass .dxtv-elb
{
	background: url('/DXR.axd?r=0_1268-K2F8m') no-repeat;
}
...
.dxtvControl_Glass.dxtvRtl .dxtv-elb
{
	background-image: url('/DXR.axd?r=0_1269-K2F8m');
}
...
{
	width: 3px;
	background: url('/DXR.axd?r=0_1213-K2F8m') repeat-y right;
	border-width: 0px;
}
...
{
	background: #F2F2F7 url('/DXR.axd?r=0_1234-K2F8m') repeat-x top left;
}
...
{
    background-image: url('/DXR.axd?r=0_1216-K2F8m');
...
.dxigItem_Glass
{
    background-repeat: no-repeat;
    background-position:center center;
    background-image: url('/DXR.axd?r=0_1214-K2F8m');
}
.dxigItem_Glass a
{
    outline: 0;
...
{
    width: 43px;
    background: url('/DXR.axd?r=0_1215-K2F8m') repeat-y;
}
.dxigControl_Glass .dxig-bottomPanel .dxis-nbBottom > .dxis-prevBtnHorWrapper
{
...
.dxrControl_Glass .dxtcLite_Glass.dxtc-top .dxr-fileTab {
    background: #d7e8ff url('/DXR.axd?r=0_1242-K2F8m') repeat-x;
    border-color: #4986a2;
    border-left-width: 1px;
    border-right-width: 1px;
}
.dxrControl_Glass .dxtcLite_Glass.dxtc-top .dxtc-tabHover.dxr-fileTab {
    background: #fecc66 url('/DXR.axd?r=0_1243-K2F8m') repeat-x;
}
.dxrControl_Glass .dxtcLite_Glass.dxtc-top .dxr-fileTabPressed.dxr-fileTab {
    background: #ffb067 url('/DXR.axd?r=0_1244-K2F8m') repeat-x;
}
